...
def main():
	...
	invalid_reason = "NULL"
	ok = True
	(ps_height, ps_nonce, ps_worker_difficulty, ps_timestamp, ps_found_by, ps_validated, ps_is_valid, ps_invalid_reason) = pool_share
	...
	if grin_share == None:
	    ...
	    (gs_hash, gs_height, gs_nonce, gs_actual_difficulty, gs_net_difficulty, gs_timestamp, gs_found_by, gs_is_solution) = grin_share
        ...
        # Update record
	print("Share {}, {} is {} because {}".format(ps_height, ps_nonce, ok, invalid_reason))
